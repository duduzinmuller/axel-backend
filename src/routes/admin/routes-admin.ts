...
import {
  makeDeleteUserManagementController,
  makeUpdateUserManagementController,
} from "../../factories/controller/admin/admin";
...
adminRouter.delete(
  ...
  requireAdmin,
  async (req: Request, res: Response) => {
    const controller = makeDeleteUserManagementController();
